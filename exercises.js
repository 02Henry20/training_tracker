...
export const BUNDLED_EXERCISES = Object.freeze([
  ...
  activity({ id: "running", name: "Outdoor Running", activityType: "running", primary: ["cardio", "quads", "glutes", "calves"], secondary: ["hamstrings", "abs"], baseMet: 9.3, speedBands: [6, 8, 10, 12, 14], fields: ["durationMin", "distanceKm", "elevationM"], aliases: ["running", "road running"] }),
  activity({ id: "treadmill-running", name: "Treadmill Running", activityType: "treadmillRunning", primary: ["cardio", "quads", "glutes", "calves"], secondary: ["hamstrings", "abs"], baseMet: 9.3, speedBands: [6, 8, 10, 12, 14], fields: ["durationMin", "distanceKm", "inclinePercent"], aliases: ["running", "threadmill running", "treadmill"] }),
  ...
  bodyweight({ id: "assisted-pull-up", name: "Assisted Pull-up", equipment: "Assisted machine", loadMode: "assisted", pattern: "Vertical pull", primary: ["lats", "biceps"], secondary: ["upperBack", "forearms"], thresholds: [1, 5, 10, 15, 22], defaultReps: 8, activeMet: 4.0 }),
  ...
  bodyweight({ id: "assisted-dip-machine", name: "Assisted Dip Machine", equipment: "Assisted machine", loadMode: "assisted", pattern: "Vertical push", primary: ["triceps", "chest"], secondary: ["frontDelts"], thresholds: [1, 6, 12, 20, 30], defaultReps: 8, activeMet: 4.0 }),
  ...
  activity({ id: "trail-running", name: "Trail Running", activityType: "trailRunning", primary: ["cardio", "quads", "glutes", "calves"], secondary: ["hamstrings", "abs"], baseMet: 10.5, speedBands: [5, 7, 9, 11, 13], fields: ["durationMin", "distanceKm", "elevationM"] }),
