...
function setRowsHtml(exercise, entry, entryIndex) {
  ...
  const loadLabel = exercise.loadMode === "assisted" ? "Assist kg" : bodyweight ? "Added kg" : exercise.loadMode === "perHand" ? "kg / hand" : exercise.loadMode === "perSide" ? "kg / side" : "Weight kg";
  const header = timed
